...
const HEADERS = [
  ...
  "Mason Notified At", "Mason Notified By", "Mason Name",
  "Mason Paid Amount", "Mason Paid Date", "Mason Paid By",
  "Stripe Session IDs",
  "Inscription Design",
  "Grave Number",
  "Archived",
...
function upsertOrder(order) {
  ...
  const valueMap = {
    ...
    "Mason Name":          order.masonName || "",
    "Mason Paid Amount":   order.masonPaidAmount || "",
    "Mason Paid Date":     order.masonPaidDate || "",
    "Mason Paid By":       order.masonPaidBy || "",
...
function mapSheetOrderToTracker(sheetOrder) {
  return {
    ...
    masonName:           sheetOrder["Mason Name"] || "",
    masonPaidAmount:     sheetOrder["Mason Paid Amount"] || "",
    masonPaidDate:       sheetOrder["Mason Paid Date"] || "",
    masonPaidBy:         sheetOrder["Mason Paid By"] || "",
